...
public class UpdateProperty extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chkSelectAllServices = new javax.swing.JCheckBox();
        chkIsAvalible = new javax.swing.JCheckBox();
        ...
        cmbCharacteristics.setBounds(610, 230, 190, 30);
        ...
        spinDemand.setBounds(300, 160, 100, 30);
        ...
        spinVariation.setBounds(500, 160, 80, 30);

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel20.setText("Number of Rooms");
        jPanel11.add(jLabel20);
        jLabel20.setBounds(600, 160, 110, 30);
        ...
        spinQuantity.setBounds(810, 230, 50, 30);
        ...
        chkIsResidential.setBounds(860, 160, 100, 30);

        spinDate.setModel(new javax.swing.SpinnerDateModel(new java.util.Date(), null, new java.util.Date(), java.util.Calendar.YEAR));
        ...
        jScrollPane2.setBounds(470, 230, 130, 200);
        ...
        jLabel23.setBounds(610, 200, 130, 30);
        ...
        jScrollPane3.setBounds(20, 350, 440, 100);
        ...
        jScrollPane4.setBounds(20, 230, 440, 90);
        ...
        jLabel25.setBounds(470, 200, 90, 30);
        ...
        spinNoOfRooms.setBounds(710, 160, 50, 30);

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel26.setText("Variation");
        jPanel11.add(jLabel26);
        jLabel26.setBounds(430, 160, 70, 30);
        ...
        jScrollPane5.setBounds(610, 270, 340, 150);
        ...
        btnRemoveCharacteristic.setBounds(710, 420, 170, 30);
        ...
        btnAddCharacteristic.setBounds(880, 230, 60, 30);
        ...
        jLabel27.setBounds(810, 200, 70, 30);
        ...
        chkSelectAllServices.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkSelectAllServices.setText("Select All");
        chkSelectAllServices.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkSelectAllServicesActionPerformed(evt);
            }
        });
        jPanel11.add(chkSelectAllServices);
        chkSelectAllServices.setBounds(470, 430, 130, 23);

        chkIsAvalible.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkIsAvalible.setText("Avalible");
        chkIsAvalible.setToolTipText("Is Property Residential?");
        jPanel11.add(chkIsAvalible);
        chkIsAvalible.setBounds(780, 160, 80, 30);
    ...
    private void lstServicesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstServicesMouseClicked
        ...
        if (index >= 0) {
            ...
            if (selectedServices.size() != serviceList.size()) {
                chkSelectAllServices.setSelected(false);
            } else {
                chkSelectAllServices.setSelected(true);
            }
        }
    ...
    private void btnAddPropertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPropertyActionPerformed
        ...
        boolean isAvalible = chkIsAvalible.isSelected();
        Date dateOfOwnership = (Date) spinDate.getValue();
        int noOfRooms = (int) spinNoOfRooms.getValue();

        if (!validation.isEmpty(address)) {
            if (!validation.isEmpty(agreement)) {
                Property property = propertiesList.get(cmbProperties.getSelectedIndex());//new Property(customer, type, filter, block, dateOfOwnership, currentDate, size, demand, variation, address, agreement, isResidential, selectedCharacteristic, selectedServices, selectedImagesLinks);
                property.setType(type);
                property.setFilter(filter);
                property.setSize(size);
                property.setDemand(demand);
                property.setVariation(variation);
                property.setAddress(address);
                property.setAgreement(agreement);
                property.setIsResidential(isResidential);
                property.setIsAvalible(isAvalible);
                property.setDateOfOwnerShip(dateOfOwnership);
                property.setNoOfRooms(noOfRooms);
                if (propertyManager.updateProperty(property)) {
                    dialog.show("Property Successfully Updated");
                    btnResetActionPerformed(evt);
                } else {
    ...
    private void cmbPropertiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbPropertiesActionPerformed
        ...
        if (index >= 0) {
            ...
            spinDate.setValue(property.getDateOfOwnerShip());
            PropertyType type = property.getType();
            int propertyTypeIndex = -1;
            boolean found = false;
            for (int i = 0; i < propertyTypeList.size() && !found; i++) {
                if (propertyTypeList.get(i).getTypeName().equals(type.getTypeName())) {
                    propertyTypeIndex = i;
                    found = true;
                }
            }
            if (propertyTypeIndex >= 0) {
                cmbPropertyType.setSelectedIndex(propertyTypeIndex);
            }
            PropertyFilter filter = property.getFilter();
            int propertyForIndex = -1;
            for (int i = 0; i < propertyForList.size() && !found; i++) {
                if (propertyForList.get(i).getFilterName().equals(filter.getFilterName())) {
                    propertyTypeIndex = i;
                    found = true;
                }
            }
            if (propertyForIndex >= 0) {
                cmbPropertyFilter.setSelectedIndex(propertyForIndex);
            }
            spinSize.setValue(property.getSize());
            spinDemand.setValue(property.getDemand());
            spinVariation.setValue(property.getVariation());
            spinNoOfRooms.setValue(property.getNoOfRooms());
            chkIsResidential.setSelected(property.isResidential());
            chkIsAvalible.setSelected(property.isAvalible());
            txtAddress.setText(property.getAddress());
            txtAgreement.setText(property.getAgreement());
            selectedServices = property.getServices();
            selectedCharacteristic = property.getCharacteristics();
            selectSelectedServices();
            createTable();
        }
    }//GEN-LAST:event_cmbPropertiesActionPerformed

    private void chkSelectAllServicesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkSelectAllServicesActionPerformed
        // TODO add your handling code here:
        if (chkSelectAllServices.isSelected()) {
            selectAllServices();
        } else {
            deselectAllServices();
        }
    }//GEN-LAST:event_chkSelectAllServicesActionPerformed

    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        // TODO add your handling code here:
        spinDate.setValue(new Date());
        spinDemand.setValue(5000);
        spinNoOfRooms.setValue(0);
        spinVariation.setValue(1000);
        spinSize.setValue(10);
        txtAddress.setText("");
        txtAgreement.setText("No Agreement");
        model = (DefaultTableModel) tblCharacteristics.getModel();
        model.setRowCount(0);
    ...
    private void cmbBlocksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBlocksActionPerformed
        ...
        if (customerIndex >= 0 && blockIndex >= 0) {
            //SELECT * FROM `property` WHERE `blockId` = 1 and `customerid` = 1
            Customer customer = customerList.get(customerIndex);
    ...
    private javax.swing.JCheckBox chkIsAvalible;
    private javax.swing.JCheckBox chkIsResidential;
    private javax.swing.JCheckBox chkSelectAllServices;
    ...
    private void createTable() {
        tblCharacteristics.removeAll();
        model = (DefaultTableModel) tblCharacteristics.getModel();
        model.setRowCount(0);
        for (int i = 0; i < selectedCharacteristic.size(); i++) {
            PropertyCharacteristic characteristic = selectedCharacteristic.get(i);
            model.insertRow(tblCharacteristics.getRowCount(), new Object[]{characteristic.getCharacteristicName(), characteristic.getQuantity()});
        }
    }

    private void selectSelectedServices() {
        for (int index = 0; index < serviceList.size(); index++) {
            CheckListItem item = (CheckListItem) lstServices.getModel().getElementAt(index);

            PropertyService service = serviceList.get(index);
            if (selectedServices.contains(service)) {
